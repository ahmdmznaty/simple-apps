...
function slideMove(direction) {
    if( direction === "prev" ) document.querySelector(".trending-section .swiper-button-prev").click()
    else if( direction === "next" ) document.querySelector(".trending-section .swiper-button-next").click()
}
